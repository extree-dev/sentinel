...
export default function Dashboard() {
    ...
    const fetchGuildMembers = async () => {
        ...
        try {
            ...
            setMembersError(error instanceof Error ? error.message : 'Неизвестная ошибка');
        } finally {
...
const UsersSection = ({ members, loading, error, onRefresh }: UsersSectionProps) => {
    return (
...
const MemberCard = ({ member }: { member: DiscordGuildMember }) => {
    // Добавляем вычисление displayName и joinDate
